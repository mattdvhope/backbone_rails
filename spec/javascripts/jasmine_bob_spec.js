describe('Bob', function() {
  ...
  it('forceful questions', function() {
    var result = bob.hey("WHAT WERE YOU THINKING?");
    expect(result).toEqual('Whoa, chill out!');
  });
  ...
  it('shouting with special characters', function() {
    var result = bob.hey("OH NO, $^*@#$(*^ MONSTERS!!!111!!!!1!");
    expect(result).toEqual('Whoa, chill out!');
  });
  ...
  it('speaking calmly with umlauts', function() {
    var result = bob.hey("\xfcML\xc4\xdcTS!");
    expect(result).toEqual('Whatever.');
  });

  it('shouting with no exclamation mark', function() {
    var result = bob.hey("I'M ANGRY");
    expect(result).toEqual('Whoa, chill out!');
  });
