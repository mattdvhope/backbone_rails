...
//   it('counts properly internation characters', function() {
//     var expectedCounts = { "¡Hola!": 1, "¿Qué": 1, "tal?":1, "отрицание!": 1 };
//     expect(words("¡Hola! ¿Qué tal? отрицание!")).toEqual(expectedCounts);
//   });
...
//   it("handles properties that exist on Object's protype", function() {
